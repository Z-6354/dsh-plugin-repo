    ...
    function PluginRepoSection() {
      ...
      return h('div', { style: { fontFamily: T.fontFamily, fontSize: '14px', color: T.labelPrimary } },
        ...
        h('div', { style: { display: 'flex', gap: '8px', alignItems: 'center', flexWrap: 'wrap' } },
          h('input', { type: 'text', placeholder: '对方地址：域名或 IP，可带端口（如 dsh.example.com 或 192.168.1.10:8443）', value: remoteAddr, onChange: (e) => setRemoteAddr(e.target.value), style: { ...inputStyle, width: '340px' } }),
