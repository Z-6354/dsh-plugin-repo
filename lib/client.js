    ...
    function PluginRepoSection() {
      ...
      return h('div', { style: { fontFamily: T.fontFamily, fontSize: '14px', color: T.labelPrimary } },
        ...
        h('div', { style: { display: 'flex', gap: '8px', alignItems: 'center', flexWrap: 'wrap' } },
          h('input', { type: 'text', placeholder: '对方地址：只写 IP/域名自动用 http:3080，可带 :端口（如 192.168.1.10:8443，或 https://域名）', value: remoteAddr, onChange: (e) => setRemoteAddr(e.target.value), style: { ...inputStyle, width: '420px' } }),
