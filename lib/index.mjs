...
function apply(ctx, config = {}) {
  ...
  //   - a bare domain/IP ("192.168.1.10", "dsh.example.com") → http://<host>:<port>
  //   - a domain/IP + :port ("192.168.1.10:3080", "dsh.example.com:8443")
  //   - a full URL ("https://dsh.example.com", "http://1.2.3.4:9000")
  // The default scheme is http; explicit https is respected. A bare host with a
  // ":port" suffix overrides rawPort, and rawPort is otherwise applied.
