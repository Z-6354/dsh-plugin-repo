...
function apply(ctx, config = {}) {
  ...
  //   - a bare IP/hostname ("192.168.1.10", "dsh.example.com") → http:<port or 3080>
  ...
  // DSH's own web carrier is plain http on port 3080 by default, so bare hosts
  // default to http:3080; use https only when the user writes it explicitly.
